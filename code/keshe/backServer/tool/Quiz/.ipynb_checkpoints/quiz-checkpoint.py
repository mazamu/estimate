...
class quiz():
    def __init__(self):
        ...
        self.path = "/home/lighthouse/课设/backServer/tool/Quiz/"
    ...
    def getResult(self,answer,wordList1,wordList2,wordList3):
        ...
        for i in range(len(answer)):
            if answer[i]['flag'] == True and answer[i]['word'] in wordList1:
                ieltsrightCount += 1
                continue
            elif answer[i]['flag'] == True and answer[i]['word'] in wordList2:
                cetrightCount += 1
                continue
            elif answer[i]['flag'] == True and answer[i]['word'] in wordList3:
                bstrightCount += 1
                continue
